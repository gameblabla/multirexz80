...
uint8_t hc_256[228] =
{
  /* Cycle-indexed SMS/GG H counter table.  This matches the Emulicious/
   * Gearsystem timing model used by VDPTEST: the counter is latched from the
   * current line cycle without the old SMS Plus phase rotation. */
